...
class TabsTray extends TwoWayView
    ...
    public TabsTray(Context context, AttributeSet attrs) {
        ...
        mTabsAdapter = new TabsTrayAdapter(mContext, this);
    ...
    class TabsTrayAdapter extends TabsAdapter {

        public TabsTrayAdapter(Context context, AdapterView<ListAdapter> adapterView)  {
            super(context, adapterView);
        }

        @Override
        boolean isVertical() {
            return TabsTray.this.isVertical();
        }

        @Override
        void animateClose(final View view, int pos) {
            TabsTray.this.animateClose(view, pos);
        }
